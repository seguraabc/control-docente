...
const CourseModal: React.FC<CourseModalProps> = ({ course, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-md m-4 border border-gray-200 dark:border-gray-700 transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-scale"
      ...
      >
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="course-name" className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
                Nombre del curso
              </label>
              <input
                id="course-name"
            ...
            <div className="mb-6">
              <label htmlFor="course-schedule" className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
                Días y horarios
              </label>
              <input
                id="course-schedule"
