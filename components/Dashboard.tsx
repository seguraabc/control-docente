    ...
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-100">Mis Cursos</h1>
             <button
                onClick={onOpenSemesterModal}
                className="flex items-center justify-center p-2 bg-gray-800 text-gray-400 font-semibold rounded-lg shadow-md hover:bg-gray-700 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-950 focus:ring-indigo-500"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {activeCourses.length > 0 ? (
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3 text-center py-12 bg-gray-900 rounded-lg">
            <h3 className="text-xl text-gray-400">No tienes cursos activos.</h3>
            <p className="text-gray-500 mt-2">¡Crea tu primer curso para empezar!</p>
          </div>
        )}
      </div>
      ...
      {archivedCourses.length > 0 && (
        <>
          <h2 className="text-2xl font-bold text-gray-100 mt-12 mb-6 border-t border-gray-800 pt-6">Cursos Archivados</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
