  ...
  const Step: React.FC<{ number: number; title: string; children: React.ReactNode }> = ({ number, title, children }) => (
    <div className="flex">
      ...
      <div>
        ...
        <div className="mt-2 text-gray-600 dark:text-gray-400 space-y-2">{children}</div>
      </div>
    </div>
  );

  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-3xl text-left bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-800">
        ...
        <main className="space-y-6">
          <Step number={1} title="Ve a la Google Cloud Console">
            ...
            <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer" className="inline-block text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-semibold underline">
          ...
          <Step number={2} title="Crea un Proyecto y Habilita las APIs">
             ...
             <ul className="list-disc list-inside pl-2">
                <li><code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">Google Sheets API</code></li>
                <li><code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">Google Drive API</code> (necesaria para crear el archivo inicial)</li>
             </ul>
          </Step>
            ...
            <ol className="list-decimal list-inside pl-2 space-y-3 mt-2">
                <li>
                 ...
                 <li>
                    ...
                    <ul className="list-disc list-inside pl-4 mt-2 text-gray-500 dark:text-gray-500 space-y-2">
                        ...
                        <li>
                            ...
                            <ul className="list-[circle] list-inside pl-5 mt-1 text-gray-600 dark:text-gray-400">
                                <li>Tu URL de desarrollo local (ej: <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded text-xs">http://localhost:5173</code>).</li>
                                <li>Tu URL de producción final (ej: <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded text-xs">https://control-docente.vercel.app</code>).</li>
                            </ul>
          ...
          <Step number={4} title="Configura tus Variables de Entorno">
            <p>En lugar de editar el código, usarás variables de entorno. Esto es más seguro.</p>
             <div className="mt-3">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">Para Desarrollo Local:</h4>
                <p>Crea un archivo llamado <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">.env</code> en la raíz de tu proyecto (junto a `index.html`) y añade tus credenciales:</p>
                <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-md mt-2 text-sm font-mono">
                    <p>VITE_GOOGLE_API_KEY="<span className="text-yellow-600 dark:text-yellow-300">PEGA_TU_API_KEY_AQUI</span>"</p>
                    <p>VITE_GOOGLE_CLIENT_ID="<span className="text-yellow-600 dark:text-yellow-300">PEGA_TU_CLIENT_ID_AQUI</span>"</p>
                </div>
                 <p className="text-xs text-gray-500 mt-1">El prefijo `VITE_` es importante. No lo olvides.</p>
            </div>
             <div className="mt-4">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">Para Producción (en Vercel):</h4>
                <p>Ve a tu proyecto en Vercel, luego a <strong>Settings &rarr; Environment Variables</strong>. Añade las mismas dos variables:</p>
                 <ul className="list-disc list-inside pl-2 mt-2">
                    <li><code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">VITE_GOOGLE_API_KEY</code> con tu Clave de API como valor.</li>
                    <li><code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">VITE_GOOGLE_CLIENT_ID</code> con tu ID de cliente como valor.</li>
                 </ul>
            </div>
          </Step>
        </main>
