...
const SemesterSettingsModal: React.FC<SemesterSettingsModalProps> = ({ currentDates, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-gray-900 rounded-lg shadow-xl w-full max-w-lg m-4 border border-gray-700 transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-scale"
        onClick={(e) => e.stopPropagation()}
        style={{ animation: 'fade-in-scale 0.3s forwards' }}
      >
        <div className="p-6">
          <h2 id="modal-title-semester" className="text-2xl font-bold text-gray-100 mb-4">
            Configurar Fechas de Cuatrimestres
          </h2>
          <form onSubmit={handleSubmit}>
            <div className="space-y-4 mb-6">
                <div className="p-4 border border-gray-700 rounded-lg">
                    <h3 className="text-lg font-semibold text-indigo-400 mb-3">Primer Cuatrimestre</h3>
                 ...
                 <div className="p-4 border border-gray-700 rounded-lg">
                    <h3 className="text-lg font-semibold text-indigo-400 mb-3">Segundo Cuatrimestre</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
